...
uint8_t playFrameCount = 0;
unsigned long playFrameInterval = 200;
unsigned long playMaxLoops = 3;
...
NimBLECharacteristic* pNetworksChar = nullptr;
bool bleNetworkScanRequested = false;
